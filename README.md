...
||[motion_tracking_rl.ipynb](./motion_tracking_rl.ipynb)| This notebook covers the MuJoCo fundamentals needed for **motion tracking RL** (e.g., DeepMimic, BeyondMimic). Topics include humanoid model anatomy, state representation (qpos/qvel), quaternion math, PD control, reference motion, DeepMimic-style reward design, and a complete tracking demo with RL env skeleton.|![tracking_rewards](./imgs/tracking_rewards.png)|
